...
<form class="alinear">
  ...
  <div class="texto">
    <select class="texto" ng-options="tema.descripcion_tema for tema in temas" ng-model="folio.id_tema" ng-change="setIdTema(folio.id_tema)">
  ...
  <div >
    ...
    <p class="texto2 text-muted text-gray-900">A continuación redacte su solicitud de manera clara y concisa,
  ...
  <div>
    <textarea class="alinear5 margen3 text2" maxlength="1000"  id="referencia_solicitud"></textarea>
  </div>
  <div class="row justify-content-center">
    <div class="col-12 col-md-10 col-lg-8">
      <hr class="linea-g">
  ...
  <div class="row justify-content-center">
    <div class="col-11 col-md-10 col-lg-8 mb-4 mt-4">
      ...
      <div id="nombre-completo">
        <div class="row justify-content-center">
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <input type="text" mask="12345" restrict="reject" class="form-control form-control-sm input-secondary ng-pristine ng-untouched ng-empty ng-invalid ng-invalid-required" id="celular" name="celular" ng-model="folio.celular" placeholder="55555555" required="">
            </div>
          </div>
        </div>
        <div class="margen6">
        ...
        <div class="row justify-content-center">
          <h5 class="text-primary-light font-weight-bold">Imagen de respaldo</h5>
...
<script src="<%=context%>/Integradora/ASCOVE-Project-master/web app/jss/main.js"></script>
</body>
</html>